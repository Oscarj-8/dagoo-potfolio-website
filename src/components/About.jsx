    ...
    >
      <div className="mt-[15em] flex flex-col p-4 gap-2 lg:flex-row xl:w-[70em] items-center max-w-[400px] lg:max-w-full text-white">
        <div className="flex flex-col gap-4 xl lg:w-[60]">
          ...
          <button className="text bg-gradient-to-r from-mainColor to-secondaryColor w-[9em] p-[10px] rounded-3xl drop-shadow-[0px_5px_2px_rgba(0,0,0,0.25)] transition-all duration-500 ease-in-out hover:drop-shadow-none ">
            Contact us
          </button>
        </div>
        <img
